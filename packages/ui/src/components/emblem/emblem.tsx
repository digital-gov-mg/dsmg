...
export function Emblem({type = 'rectangle'}: EmblemProps): JSX.Element{
 ...
 return  (
  <StyledEmblem type={type}>
   {type === 'rectangle' && (
    <svg fill="none" height="48" viewBox="0 0 72 48" width="72" xmlns="http://www.w3.org/2000/svg">
   ...
   {type === 'round' && (
    <svg fill="none" height="48" viewBox="0 0 48 48" width="48" xmlns="http://www.w3.org/2000/svg">
      <path d="M24 24H48C48 37.2548 37.2548 48 24 48V24Z" fill="#00843D"/>
      <path d="M24 0C37.2548 0 48 10.7452 48 24H24V0Z" fill="#F9423A"/>
      <path d="M0 24C0 10.7452 10.7452 0 24 0V48C10.7452 48 0 37.2548 0 24Z" fill="white"/>
    </svg>
    )}
 </StyledEmblem>
 )
